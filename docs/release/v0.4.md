...
+ `api`
    + `timeout` 설정 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/108">#108</a>">#108</a>)
...
+ Camel case와 snake case로 난잡하게 정의된 함수 및 변수명을 snake case와 pascal case로 획일화 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/107">#107</a>">#107</a>)
