...
- `mlops`
    - `TYPE_STRING` 입력에 대한 gRPC client 오류 수정
    - Dynamic batching 시 올바르지 않은 batch index log 수정

## v1.2.6

<h3>[v1.2.6] Release (<a href=https://github.com/Zerohertz/zerohertzLib/pull/389>#389</a>)</h3>
...
- `api`
    - `GitHub` class의 `release_note` 함수에서 외부 repository의 issue 또는 PR href issue 수정 (resolves: <a href="https://github.com/Zerohertz/zerohertzLib/issues/377">#377</a>)
