...
- `api`
    - Release note 내 타 repository의 issue 또는 PR의 `<a>` tag 지원 (<a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/377">#377</a>">#377</a>)
- `quant`
...
- <s>PyTest 시 잦은 실패로 random sleep 추가</s> → <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/363">#363</a>">#363</a>
