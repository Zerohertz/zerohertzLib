...
+ 의존성으로 인해 특정 code에 대해 호출이 정상적으로 이뤄지지 않는 현상 수정 (related: <a href="https://github.com/FinanceData/FinanceDataReader/issues/230">FinanceData/FinanceDataReader <a href="https://github.com/Zerohertz/zerohertzLib/issues/230">#230</a></a>)
