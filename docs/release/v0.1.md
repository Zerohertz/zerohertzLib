...
+ `plot`
    ...
    + Pie chart의 label에 소수 자리가 생기는 문제 해결 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/40">#40</a>">#40</a>)
+ `vision`
    + `cv2` 의존성이 설치되지 않은 경우에도 사용할 수 있도록 변경
    + Image의 전후 비교를 위한 `before_after` 함수 개발
    + 여러 image를 한번에 요약해 볼 수 있는 `grid` 함수 개발 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/39">#39</a>">#39</a>)

<h4>Chore</h4>

+ Issue 및 PR의 tag 생성 추가 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/41">#41</a>">#41</a>)
...
+ Jenkins의 trigger 수정 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/34">#34</a>">#34</a>)
...
+ `api`
    + `openai` package의 update로 의존성 error 발생 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/25">#25</a>">#25</a>)
+ `logging`
    + `Logger` 추가
+ `mlops`
    + Triton inference server의 Client를 손쉽게 사용할 수 있는 class `tritonClientURL`, `tritonClientK8s` 추가 
    + 변수명 수정 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/28">#28</a>">#28</a>)
...
+ `vision`
    + GIF 변환을 위한 `img2gif`, `vid2gif` 함수 추가 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/22">#22</a>">#22</a>)
...
+ Sphinx 문서 build 시 branch 이름을 parsing하여 변경하도록 update (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/15">#15</a>">#15</a>)
...
+ `commitMessage`를 정의하는 pipeline 추가 (<a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/10">#10</a>">#10</a>)
