...
+ 단순 `Exception`으로 표기했던 예외 처리의 수정 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/103">#103</a>">#103</a>)
...
+ 예제 image 변경 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/99">#99</a>">#99</a>)
