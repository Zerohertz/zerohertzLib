...
+ `quant`
    + `cnt_total` 변수의 오류 수정 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/158">#158</a>">#158</a>)
    + Report의 양식 수정
...
+ `setBuildStatus` 이상 해결 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/144">#144</a>">#144</a>)
...
+ `GitHub` stage의 release 오류 해결 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/135">#135</a>">#135</a>)
...
+ `api`
    + Slack Webhook 및 Bot 사용 시 `message` method의 입력이 `""`인 경우 전송 취소 (resolves: <a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/132">#132</a>">#132</a>)
+ `logging`
...
+ <del>`GitHub` stage에서 `import` 오류 수정</del>
    + `cv2` dependency로 인해 `GitHub` stage 실패 (<a href="<a href="https://github.com/Zerohertz/zerohertzLib/issues/135">#135</a>">#135</a>) → [v0.5.2](<a href="https://github.com/Zerohertz/zerohertzLib/pull/136">#136</a>)에서 해결
