...
+ 코드 내 문서가 아닌 주석 수정 (resolves: <a href="https://github.com/Zerohertz/zerohertzLib/issues/79">#79</a>)
...
+ `api`
  + GitHub API 활용을 위한 `GitHub` 객체 개발 (resolves: <a href="https://github.com/Zerohertz/zerohertzLib/issues/62">#62</a>)
...
+ `api`
  + `Discord` 객체화
  + 이미지 전송 메서드 개발 (resolves: <a href="https://github.com/Zerohertz/zerohertzLib/issues/50">#50</a>)
+ `logging`
  + `Discord` 객체 적용
+ `vision`
  + 이미지 시각화 함수 `bbox`, `masks`, `text` 개발 (resolves: <a href="https://github.com/Zerohertz/zerohertzLib/issues/49">#49</a>)
